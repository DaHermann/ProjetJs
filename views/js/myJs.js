                ...
                server.get('/',function(req, res){
                    ...
                    server.post('/', function(req, res) {
                            ...
                            if (err) {
                                ...
                                // try
                                // {
                                //     $bdd = new PDO('mysql:host=localhost;dbname=venci;charset=utf8', 'root', '');
                                // }
                                // catch (Exception $e)
                                // {
                                ...
                                // $req = $bdd->prepare('INSERT INTO members (nom, prenom, email, mot_pass, profile, tel, sexe) VALUES(:nom, :prenom, :email, :mot_pass, :profile, :tel, :sexe)');
                                // $req->execute(array(
                                //     'nom' => $_POST['nom'],
                                //     'prenom' => $_POST['prenom'],
                                //     'email' => $_POST['email'],
                                //     'mot_pass' => $_POST['pwd'],
                                //     'profile' => $_POST['selection'],
                                //     'tel' => $_POST['tel']
                                //     'sexe' => $_POST['sexe']
                                //     ));
